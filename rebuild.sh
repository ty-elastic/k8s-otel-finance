...
docker build --platform $arch --build-arg VARIANTS=false --build-arg COURSE=$COURSE --progress plain -t us-central1-docker.pkg.dev/elastic-sa/tbekiares/$service:$IMAGE_VERSION src/$service
